...
class global_agent():
	...
	# def __init__(self,all_the_agents):
	# 	self.all_the_agents = all_the_agents
	# 	self.initialize_hyperparam()

	def initialize_hyperparam(self):
		self.Transition = namedtuple('Transition',('state', 'action', 'next_state', 'reward'))		
		# self.optimizer_agent = optim.RMSprop(self.policy_net_agent, lr = lr_1, weight_decay = weight_decay_1)
		...
		self.optimizer_agent = optim.RMSprop(params, lr = lr_1, weight_decay = weight_decay_1)	
