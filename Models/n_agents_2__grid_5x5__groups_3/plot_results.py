...
if __name__ == "__main__":
	...
	plt.fill_between(stat_n_iter_IQL_diff, smooth(IQL_diff_stat_system_rewards_mean-IQL_diff_system_rewards_std_dev,smoothening_factor), smooth(IQL_diff_stat_system_rewards_mean+IQL_diff_system_rewards_std_dev,smoothening_factor),
	...
	plt.fill_between(stat_n_iter_IQL_global, smooth(IQL_global_stat_system_rewards_mean-IQL_global_system_rewards_std_dev,smoothening_factor), smooth(IQL_global_stat_system_rewards_mean+IQL_global_system_rewards_std_dev,smoothening_factor),
	...
	# Plot VDN
	plt.plot(stat_n_iter_VDN, smooth(VDN_stat_system_rewards_mean,smoothening_factor), 'k', label='VDN', color='#3F7F4C')
	plt.fill_between(stat_n_iter_VDN, smooth(VDN_stat_system_rewards_mean-VDN_system_rewards_std_dev,smoothening_factor), smooth(VDN_stat_system_rewards_mean+VDN_system_rewards_std_dev,smoothening_factor),
	...
	plt.fill_between(stat_n_iter_IQL_global, smooth(IQL_global_system_successes_mean-IQL_global_system_successes_std_dev,smoothening_factor), smooth(IQL_global_system_successes_mean+IQL_global_system_successes_std_dev,smoothening_factor),
		alpha=0.5, edgecolor='#1B2ACC', facecolor='#089FFF')
	...
	# Plot VDN
	plt.plot(stat_n_iter_VDN, smooth(VDN_system_successes_mean,smoothening_factor), 'm-', label='VDN', color='#3F7F4C')
	plt.fill_between(stat_n_iter_VDN, smooth(VDN_system_successes_mean-VDN_system_successes_std_dev,smoothening_factor), smooth(VDN_system_successes_mean+VDN_system_successes_std_dev,smoothening_factor),
		alpha=0.5, edgecolor='#3F7F4C', facecolor='#7EFF99')
